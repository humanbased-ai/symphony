...
from jazzband.auth import MissingLinearTokenError, TokenStore, redact_secret
...
query JazzbandLinearIssueComments($issueId: String!, $first: Int!, $cursor: String) {
  issue(id: $issueId) {
...
query JazzbandWorkflowStates($teamId: ID!) {
...
TEAM_ID_QUERY = """
query JazzbandTeamId($projectSlug: String!) {
...
mutation JazzbandCreateComment($issueId: String!, $body: String!) {
...
mutation JazzbandUpdateIssueState($issueId: String!, $stateId: String!) {
